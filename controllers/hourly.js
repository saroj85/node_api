...
const get_all_hourly_data = async (req, res) => {
    ...
    try {
        ...
        const all_hourly_data = await find_all(db.hourly, where);
...
const save_hourly_data = async (req, res) => {
    try {
        ...
        const saved_hourly_data = await save(db.hourly, hourly_data);
...
const get_hourly_by_id = async (req, res) => {
    ...
    try {
        ...
        const hourly_data = await find_by_id(db.hourly, id);
